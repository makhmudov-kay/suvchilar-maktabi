...
export class Constants {
  ...
  public static readonly POSITION_WORKER = 2;
  public static readonly POSITION_WATERMAN = 3;
  public static readonly POSITION_IRRIGATOR = 4;
  public static readonly POSITION_BANK_EMPLOYEE = 5;
  public static readonly POSITION_OTHER = 6;
  ...
  public static readonly DOMAINS = {
    prod: 'suvchimaktabi.uz',
    dev: '91.213.99.234:8000',
  };
